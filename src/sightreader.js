...
//             let headers = [];
//             let notes = [];
//             let headerFields = new Set(['T', 'C', 'Z', 'S', 'N', 'G', 'O', 'H', 'I', 'P', 'W', 'F', 'B']);
...
//                     if (headerFields.has(line[0].toUpperCase())) {
//                         console.log('Ignoring header:', line);
//                         continue;
//                     }
//                     console.log('Keeping header:', line);
//                     headers.push(line);
//                 } else {
//                     console.log('Keeping notes:', line);
//                     notes.push(line);
//                 }
//             }

//             let processedData = headers.join('\n') + '\n' + notes.join('\n');
